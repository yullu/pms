            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ url('admin/medicines/edit/'.$medicines->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                <label for="name" class="col-sm-2 col-formlabel">Drug Name <span style="color: red;">*</span></label>
                                <div class="col-sm-10">
                                    <input type="text" name="name" class="form-control" value="{{ $medicines->name }}">
                                    @error('name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="packing" class="form-control" value="{{ $medicines->packing }}">
                                    @error('packing')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-secondary">Edit Drug</button>
                                </div>
                            </div>
